        ...
        <div className="navbar-container max-w-[1400px] mx-auto px-5 sm:px-8 lg:px-16">
          <div className="navbar-inner flex items-center justify-between h-16 lg:h-[70px]">
            ...
            <Link to="/" className="flex-shrink-0">
              <img src={asset("AmadalGreen.webp")} alt="Amadal Global Systems" width="120" height="36" className="h-8 lg:h-9 w-auto" />
            </Link>
      ...
      <div className={`fixed top-0 right-0 h-full w-full bg-white z-[9999] lg:hidden
        ...
        <div className="flex items-center justify-between px-6 py-4 border-b border-gray-100">
          <Link to="/" onClick={() => setMobileOpen(false)}>
            <img src={asset("AmadalGreen.webp")} alt="Amadal Global Systems" width="120" height="28" className="h-7 w-auto" />
          </Link>
          <button
            onClick={() => setMobileOpen(false)}
