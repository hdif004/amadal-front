...
const ContactPage = () => {
  ...
  const phones = ["+212522404987", "+212600008321", "+212600008318", "+212600307777"];
  ...
  return (
    <>
      ...
      <div className="min-h-screen bg-[#f7faf9] pt-16">
          ...
          <div className="max-w-[1400px] mx-auto px-5 sm:px-8 lg:px-16 py-12 lg:py-16">
            <div className="flex flex-col gap-3 max-w-2xl">
              <div className="inline-flex items-center gap-2">
                ...
                <span className="text-xs font-semibold uppercase tracking-[0.18em] text-primary/60">Contact</span>
              </div>
        ...
        {/* Contenu */}
        <div className="max-w-[1400px] mx-auto px-5 sm:px-8 lg:px-16 py-12 lg:py-16">
          <div className="grid grid-cols-1 lg:grid-cols-[360px_1fr] xl:grid-cols-[400px_1fr] gap-8 lg:gap-12 items-start">
            ...
            <div className="flex flex-col gap-5">
              <div className="bg-white rounded-2xl border border-gray-100 shadow-sm p-6 flex flex-col gap-5">
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    <p className="text-xs font-bold uppercase tracking-widest text-primary/60 mb-1">{t("contact.callUs")}</p>
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    <p className="text-xs font-bold uppercase tracking-widest text-primary/60 mb-1">{t("contact.visitUs")}</p>
              ...
              <div className="bg-white rounded-2xl border border-gray-100 shadow-sm p-6">
                <p className="text-xs font-bold uppercase tracking-widest text-primary/60 mb-4">{t("contact.followUs")}</p>
                <div className="flex items-center gap-3">
                  <a href="https://web.facebook.com/AMADALGLOBAL/" target="_blank" rel="noopener noreferrer"
                    className="w-10 h-10 rounded-xl bg-primary/10 flex items-center justify-center hover:bg-primary hover:text-white text-primary transition-colors">
            ...
            {/* Map */}
            <div className="h-[400px] lg:h-full min-h-[400px] rounded-2xl overflow-hidden border border-gray-100 shadow-sm">
              <GoogleMap />
            </div>
